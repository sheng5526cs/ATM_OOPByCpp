    ...
    : QObject(parent)
{
    ...
    depositwin = new depositWindow; // 新增：存款視窗    transwin = new TransWindow;
    ...
    // 連接計時器信號
    connect(sessionTimer, &QTimer::timeout, this, &Controller::sessionTimeout);
    connect(warningTimer, &QTimer::timeout, this, &Controller::showSessionWarning);
