    ...
    , ui(new Ui::withdrowWindow)
{
    ui->setupUi(this);
    refreshBalance();
    connect(ui->f1000, &QPushButton::clicked, this, &withdrowWindow::on_f1000_clicked);
    connect(ui->f2000, &QPushButton::clicked, this, &withdrowWindow::on_f2000_clicked);
    connect(ui->f3000, &QPushButton::clicked, this, &withdrowWindow::on_f3000_clicked);
    connect(ui->f5000, &QPushButton::clicked, this, &withdrowWindow::on_f5000_clicked);
    connect(ui->f10000, &QPushButton::clicked, this, &withdrowWindow::on_f10000_clicked);
    connect(ui->clear, &QPushButton::clicked, this, &withdrowWindow::on_clear_clicked);
    connect(ui->back, &QPushButton::clicked, this, &withdrowWindow::on_back_clicked);
    connect(ui->logout, &QPushButton::clicked, this, &withdrowWindow::on_logout_clicked);
}
...
void withdrowWindow::on_f1000_clicked() { ui->withdrow->setText("1000"); }
void withdrowWindow::on_f2000_clicked() { ui->withdrow->setText("2000"); }
void withdrowWindow::on_f3000_clicked() { ui->withdrow->setText("3000"); }
void withdrowWindow::on_f5000_clicked() { ui->withdrow->setText("5000"); }
void withdrowWindow::on_f10000_clicked() { ui->withdrow->setText("10000"); }
...
void withdrowWindow::on_withdraw_clicked() {
    ...
    refreshBalance();
    QMessageBox::information(this, "成功", QString("成功提款 %1 元！").arg(amount));
    ui->withdrow->clear();
}
